  ...
  tenant_a: [
    {
      ...
      badge: 'Popular',
      text: '✨ Our 2026 Luxe Haven catalog is now live! Explore over 50 handcrafted pieces — from the Imperial King Bed (₹1,95,000) to our signature Sovereign Sofa Set (₹2,85,000).\n\nReply *CATALOG* and we\'ll send you the full digital catalog instantly.',
      mediaUrl: '',
      mediaType: 'none',
    },
    {
